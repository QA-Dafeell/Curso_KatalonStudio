...
WebUI.selectOptionByLabel(findTestObject('Reto_select/select'), 'Multiply', false)

WebUI.click(findTestObject('Reto_select/calculate'))

WebUI.delay(3)

WebUI.click(findTestObject('Reto_select/clear'))

WebUI.setText(findTestObject('Reto_select/campo_1'), '50')

WebUI.setText(findTestObject('Reto_select/campo_2'), '5')

WebUI.selectOptionByLabel(findTestObject('Reto_select/select'), 'Divide', false)
